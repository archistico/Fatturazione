                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Categorie più acquistate</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="reportcategorie" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>Categoria</th>
                                                <th>Totale &euro;</th>
