...
--
-- Host: localhost
-- Creato il: Dic 30, 2016 alle 19:17
...
(1, 1, 2016, '2016-12-30', 1, '', 'Vendita', 'Mittente', 'Sfuso', '1', '2016-12-30', '100', '97.90', 0, 0, 1, 0),
(2, 2, 2016, '2016-12-30', 4, '', 'Vendita', 'Mittente', 'Sfuso', '1', '2016-12-30', '100', '9.50', 0, 0, NULL, 0),
(3, 3, 2016, '2016-12-30', 8, '', 'Vendita', 'Mittente', 'Sfuso', '1', '2016-12-30', '200', '38.00', 0, 0, NULL, 0);
...
--
ALTER TABLE `ddt`
  MODIFY `ddt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT per la tabella `ddtdettaglio`
--
ALTER TABLE `ddtdettaglio`
  MODIFY `ddd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT per la tabella `fattura`
--
ALTER TABLE `fattura`
  MODIFY `fat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
