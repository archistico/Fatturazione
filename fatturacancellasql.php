        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    if (empty($errore)) {
                        echo "<div class='callout callout-success'><h4>Fattura cancellata</h4><p>Modifiche alla base dati effettuata correttamente</p></div>";
                    }

                    if (!empty($errore)) {
                        echo "<div class='callout callout-danger'><h4>Errore nella cancellazione della fattura</h4><p>Ricontrollare i dati inseriti o chiamare l'amministratore</p></div>";
                    }
