...
try {
    ...
    foreach ($result as $row) {
        ...
        $listaDDT[] = array('ddt_id' => $row['ddt_id'], 'descrizione' => "DDT ".$numero_padded . " del " .$dataEmissione. " - ". utf8_encode($row['cli_denominazione'])." = &euro; " . $row['ddt_importo'] ." (".$row['ddt_causale'].")");
    }
    // chiude il database
    //utf8_encode()
    $db = NULL;
